...
jquery_lang_js.prototype.lang.th = {
   ...
   'Password :': 'รหัสผ่าน:',
   'Password strength':'แรงรหัสผ่าน',
   'Password not entered':'รหัสผ่านไม่ได้ป้อน',
   'Retype Password :':'รหัสผ่านอีกครั้ง:',
   'Submit':'เสนอ',
   'New User Registration':'ลงทะเบียนผู้ใช้ใหม่',
   'Pin:':'เข็ม',
   'New User':'ผู้ใช้งานใหม่',
